...
it('rounds the isolation score correctly', function () {
    ...
    $report = new EnvAuditReport([], [], [], [], [], [], [], [], [], 18, 17, 0);
...
it('returns true when any specified category has violations', function () {
    $report = new EnvAuditReport([makeCall(false)], [], [], [], [], [], [], [], [], 1, 0, 0);
